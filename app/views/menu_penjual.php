...
<div class="menupem" style="background-image: url(view/img/pexels-will-kirk-4200090.jpg);">
        <div class="but">
            <div class="box" style="background-image:url(view/img/stat.jpg);">
                <a href="pengunjung_penjual.php" class="data">Laporan Pengunjung</a>
                <a href="penjual_booking2.php" class="data">Laporan booking</a>
                <a href="penjualan_penjual.php" class="data">Laporan penjualan</a>
        </div>
    </div>
</div>
<h3>Menu Penjual</h3>
