...
<div class="con_tiket" style="background-image: url(./view/img/roman-kraft-g_gwdpsCVAY-unsplash\ -\ Copy.jpg);">
    <div class="tiket">
        <div class="tikett">
            <img src="view/img/cut.png" style="width:180px;height:150px;">
            <p>
    <?php
    echo " " . $_GET['pesan'];
    ?>
